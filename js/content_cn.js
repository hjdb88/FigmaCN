const allData = [
    ...
    [`Recents`, `最近`],
    [`Favorite files`, `收藏`],
    [`Hover over any file and click the star to add it here`, `将鼠标悬停在任何文件上，然后单击星标将其添加到此处`],

    [`Ready to go beyond this free plan? Upgrade for premium features.`, `准备好超越这个免费计划了吗？ 升级高级功能。`],
    [`View plans`, `查看计划`],
    ...
    [`Upgrade plan for unlimited design files in teams.`, `团队不限制设计文件的升级计划。`],
...
let observer = new MutationObserver(function (mutations) {
    ...
    while (currentNode) {
        ...
        } else if (currentNode.hasAttribute('data-label')) {
